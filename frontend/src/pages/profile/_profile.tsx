...
export default function Profile({ selectedUser, attempts, isCurrentUser, loadingState }: ProfileProps) {
          ...
          <CardContent>
            {loadingState === "loading" ? <div className="h-32 flex items-center justify-center">
              <DotWave
                ...
                color="white"
              />
            </div> : loadingState === "error" ? <div className="h-32 flex items-center justify-center">
              <TypographyBody>Something went wrong. Please try again later.</TypographyBody>
            </div> :
