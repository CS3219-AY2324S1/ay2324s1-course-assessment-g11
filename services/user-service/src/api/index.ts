...
indexRouter.get("/:uid", function(req : express.Request, res : express.Response) {
...
indexRouter.put("/:uid", function(req : express.Request, res : express.Response) {
...
indexRouter.delete("/:uid", function(req : express.Request, res : express.Response) {
